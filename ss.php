...
<body class="login-body" style="background: url(../assets/bg-login.png)">
    ...
    <div class="create-form">
        ...
        $id = $_SESSION['team'];
        $result =  mysqli_query($connect, "Select * from team where idEquipe=$id");
        $user = mysqli_fetch_assoc($result);
    echo '
        <label for="nomEquipe" class="sm">
            <h4>Team Name</h4>
            <input type="text" name="nomEquipe" id="nomEquipe" required value='.$user['nomEquipe'].'>
        </label>
