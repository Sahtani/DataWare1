...
if (isset($_POST['submit'])) {
    ...
    $sql="insert into project(name,start_date,end_date) values(:name,:start_date,:end_date)";
    $sth =$conn->prepare($sql);
    $sth->execute(['name'=>$name,'start_date'=>$startdate,'end_date'=>$enddate]);
if ($sth){
...
<form class=" m-auto bg-blueText2 w-full md:w-4/6 rounded-lg" method="post">
  <div class="mb-5 mx-4">
